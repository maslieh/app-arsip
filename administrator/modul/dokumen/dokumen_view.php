...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?= base_index() ?>dokumen">Dokumen</a></li>
        <li class="active">Dokumen List</li>
    </ol>
</section>
...
<section class="content">
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $dtb = $pg->myquery(
                                "select id,bidang, date from sys_bidang  $search ",
                                $limit
                            );
                            $no = $pg->Num($limit);
                            $count = $pg->Num($limit);
    ...
    <a href="<?= base_index() ?>dokumen/tambah" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
