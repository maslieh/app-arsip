...
group by jurusan.kode_jurusan");
                                            ...
                                            $data = $db->query(
                                                "select jurusan.nama_jurusan,count(mhs.id) as jumlah_mhs,jurusan.kode_jurusan,jenjang from jurusan left join mhs
on jurusan.kode_jurusan=mhs.kode_jurusan
 where jurusan.kode_jurusan='" .
                            ...
                            <tr>
                                ...
                                <td>
                                    <a
                                        href='<?= base_index() ?>mahasiswa/choose/<?= $dt->kode_jurusan ?>'><?= $dt->nama_jurusan ?></a>
                                </td>
                                <td><?= $dt->jenjang ?></td>
                                <td><?= $dt->jumlah_mhs ?></td>
