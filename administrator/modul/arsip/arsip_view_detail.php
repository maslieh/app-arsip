...
<section class="content-header">
    <h1>
        Manage arsip <?php echo $db->fetch_single_row(
            'sys_bidang',
            'id',
            $id_jur
        )->bidang; ?>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="<?= base_index() ?>arsip/tambah/<?= $id_jur ?>" class="btn btn-primary"><i
                            class="fa fa-plus"></i>
                        Tambah</a>
                            ...
                            <table id="dtb_manual" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Nama Dokumen</th>
                                        <th width='160px'>Nomor Surat / Arsip</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $dt->tahun ?></td>
                                        <td>
                                            <a href='<?= base_url() ?>upload/dokumen/<?= $dt->file ?>'><?= $dt->file ?>
                                            </a>
                                        </td>
                                        <td><a href="<?= base_index() ?>arsip/edit/<?= $dt->id ?>"
                                                class="btn btn-primary btn-flat"><i class="fa fa-pencil"></i></a>
                                            <button class="btn btn-danger btn-flat hapus"
                                                data-uri="<?= base_admin() ?>modul/arsip/arsip_action.php"
