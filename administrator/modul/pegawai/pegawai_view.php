                ...
                <section class="content">
                                ...
                                <div class="box-body table-responsive">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            left join t_jabatan on sys_users.id_jabatan=t_jabatan.id_jabatan
                                            $search",
                                                $limit
                                            );
                                            $no = $pg->Num($limit);
                                            ...
                                            foreach (
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= base_index() ?>pegawai/reset/<?= $isi->id ?>"
                    ...
                    <a href="<?= base_index() ?>pegawai/tambah" class="btn btn-primary"><i class="fa fa-plus"></i>
                        Tambah</a>