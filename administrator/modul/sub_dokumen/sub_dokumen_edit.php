...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?= base_index() ?>cabang">Data Dokumen</a></li>
            ...
            <div class="box box-solid box-primary">
                ...
                <div class="box-body">
                    <form id="update" method="post" class="form-horizontal"
                        action="<?= base_admin() ?>modul/sub_dokumen/sub_dokumen_action.php?act=up">
                        <div class="form-group">
                            <label for="Level User" class="control-label col-lg-2">Nama dokumen</label>
                            <div class="col-lg-10">
                                <input type="text" id="page_name" name="page_name" value="<?= $data_edit->sub_bidang ?>"
