                            ...
                            <div class="box">
                                ...
                                <form method="get" class="form-horizontal" action="">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <select name="user" id="id_po_select" data-placeholder="Pilih User"
                                                class="form-control chzn-select" tabindex="2">
                                                <option value=""></option>
                                                <?php foreach (
                                                    $db->query("select sys_group_users.id, sys_group_users.level from sys_users inner join sys_group_users 
on sys_users.id_group=sys_group_users.id
group by sys_group_users.id")
                                                    as $isi
                                                ) {
                                                    if (
                                                        $_GET['user'] ==
                                    ...
                                    <div class="col-lg-10">
                                        <button style="margin-top:10px;margin-bottom:10px" class="btn btn-primary">Show
                                            Menu</button>
                                        <a href="<?= base_index() ?>menu-management/tambah" class="btn btn-primary"><i
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table id="dtb"
                                        ...
                                        <tbody>
                                            <?php
                                            $dtb = $db->query(
                                                'select sys_menu.type_menu,sys_menu_role.read_act,sys_menu_role.insert_act,sys_menu_role.update_act,sys_menu_role.delete_act, sys_menu.page_name,sys_menu.urutan_menu,sys_group_users.level,sys_menu_role.id from sys_menu_role inner join sys_menu on sys_menu_role.id_menu=sys_menu.id inner join sys_group_users on sys_menu_role.group_id=sys_group_users.id where sys_group_users.id=? order by urutan_menu asc',
                                                [
                                                    'sys_group_users.id' =>
                                                        $_GET['user'],
                                                ]
                                            ...
                                            foreach (
                                                ...
                                                <td>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input class="uniform" type="checkbox" value="option1"
                                                                onclick="read_act(<?= $isi->id ?>,this)" <?= $isi->read_act ==
'Y'
    ? 'checked=""'
    : '' ?>>
                                                        </label>
    ...
    : '' ?>>
                                                ...
                                                <td>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input class="uniform" type="checkbox" value="option1"
                                                                onclick="insert_act(<?= $isi->id ?>,this)" <?= $isi->insert_act ==
'Y'
    ? 'checked=""'
    : '' ?>>
                                                        </label>
                                                ...
                                                <td>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input class="uniform" type="checkbox" value="option1"
                                                                onclick="update_act(<?= $isi->id ?>,this)" <?= $isi->update_act ==
'Y'
    ? 'checked=""'
    : '' ?>>
                                                        </label>
                                                ...
                                                <td>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input class="uniform" type="checkbox" value="option1"
                                                                onclick="delete_act(<?= $isi->id ?>,this)" <?= $isi->delete_act ==
'Y'
    ? 'checked=""'
    : '' ?>>
                                                        </label>
